...
function formatType(type) {
    ...
    //type2
    const TYPE2 = [TYPE_FUSION, TYPE_RITUAL, TYPE_SYNCHRO, TYPE_TOKEN, TYPE_XYZ, TYPE_LINK, TYPE_NORMAL, TYPE_EFFECT];
    const TYPE2_CODE = { [TYPE_NORMAL]: 'tc', [TYPE_EFFECT]: 'xg', [TYPE_FUSION]: 'rh', [TYPE_RITUAL]: 'ys', [TYPE_SYNCHRO]: 'tt', [TYPE_TOKEN]: 'tk', [TYPE_XYZ]: 'cl', [TYPE_LINK]: 'lj'};

    //type3-4
    const TYPE34 = [TYPE_NORMAL, TYPE_PENDULUM, TYPE_SPIRIT, TYPE_UNION, TYPE_DUAL, TYPE_TUNER, TYPE_QUICKPLAY, TYPE_CONTINUOUS, TYPE_EQUIP, TYPE_FIELD, TYPE_COUNTER, TYPE_FLIP, TYPE_TOON];
    const TYPE34_CODE = {[TYPE_NORMAL]: 'tc', [TYPE_PENDULUM]: 'lb', [TYPE_SPIRIT]: 'lh', [TYPE_UNION]: 'tm', [TYPE_DUAL]: 'ec', [TYPE_TUNER]: 'tz', [TYPE_QUICKPLAY]: 'sg', [TYPE_CONTINUOUS]: 'yx', [TYPE_EQUIP]: 'zb', [TYPE_FIELD]: 'cd', [TYPE_COUNTER]: 'fj', [TYPE_FLIP]: 'fz', [TYPE_TOON]: 'kt'}
